package com.example.nftmarket.utils.contract;
...
public class Market extends Contract {
    ...
    public static final String FUNC_HATCH = "hatch";

    public static final String FUNC_HATCHTIME = "hatchTime";

    public static final String FUNC_INIT = "init";

    public static final String FUNC_MATE = "mate";
    ...
    public RemoteFunctionCall<TransactionReceipt> hatch(BigInteger tokenId, String DinosaurId, String DinosaurSex, String DinosaurType, Boolean isBreeding, String DinosaurColor, String DinosaurRarity, String DinosaurPhotoUri, BigInteger DinosaurPrice, String SourceHash, Boolean isSale) {
    ...
    public RemoteFunctionCall<TransactionReceipt> mate(BigInteger dinosaurA, BigInteger dinosaurB, String EggId, String DinosaurFather, String DinosaurMother, String ChildHash, String EggPhotoURI, Boolean isHatched) {
        final Function function = new Function(
                FUNC_MATE, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(dinosaurA), 
                new org.web3j.abi.datatypes.generated.Uint256(dinosaurB), 
